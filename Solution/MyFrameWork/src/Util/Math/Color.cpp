...
Color Color::Lerp(const Color& value1, const Color& value2, float amount) {
	return Color(
		Mathf::Lerp(value1.r, value2.r, amount),
		Mathf::Lerp(value1.g, value2.g, amount),
		Mathf::Lerp(value1.b, value2.b, amount),
		Mathf::Lerp(value1.a, value2.a, amount));
}
...
Color Color::Clamp(const Color & value1, const Color & min, const Color & max) {
	return Color(
		Mathf::Clamp(value1.r, min.r, max.r),
		Mathf::Clamp(value1.g, min.g, max.g),
		Mathf::Clamp(value1.b, min.b, max.b),
		Mathf::Clamp(value1.a, min.a, max.a));
}
